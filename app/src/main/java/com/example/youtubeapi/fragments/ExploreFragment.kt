...
import com.example.youtubeapi.databinding.FragmentExploreBinding
...
class ExploreFragment : Fragment(),PopupMenu.OnMenuItemClickListener  {
...
//                findNavController().navigate(R.id.videoFragment,bundle)
            ...
            override fun onItemClickMore(item: Item, view: View) {
                ...
                popup.setOnMenuItemClickListener(this@ExploreFragment)
